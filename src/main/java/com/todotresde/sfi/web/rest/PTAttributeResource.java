...
public class PTAttributeResource {
    ...
    @Timed
    public ResponseEntity<PTAttribute> createPTAttribute(@RequestBody PTAttribute pTAttribute) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<PTAttribute> updatePTAttribute(@RequestBody PTAttribute pTAttribute) throws URISyntaxException {

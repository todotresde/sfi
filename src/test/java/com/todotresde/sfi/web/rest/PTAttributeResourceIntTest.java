...
public class PTAttributeResourceIntTest {
    ...
    public void getAllPTAttributes() throws Exception {
        ...
        restPTAttributeMockMvc.perform(get("/api/p-t-attributes?sort=id,desc"))
    ...
    public void getPTAttribute() throws Exception {
        ...
        // Get the pTAttribute
        restPTAttributeMockMvc.perform(get("/api/p-t-attributes/{id}", pTAttribute.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void getNonExistingPTAttribute() throws Exception {
        // Get the pTAttribute
        restPTAttributeMockMvc.perform(get("/api/p-t-attributes/{id}", Long.MAX_VALUE))
    ...
    public void updatePTAttribute() throws Exception {
        ...
        restPTAttributeMockMvc.perform(put("/api/p-t-attributes")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
    ...
    public void deletePTAttribute() throws Exception {
        ...
        // Get the pTAttribute
        restPTAttributeMockMvc.perform(delete("/api/p-t-attributes/{id}", pTAttribute.getId())

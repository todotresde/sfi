...
public class STAttributeResourceIntTest {
    ...
    public void getAllSTAttributes() throws Exception {
        ...
        restSTAttributeMockMvc.perform(get("/api/s-t-attributes?sort=id,desc"))
    ...
    public void getSTAttribute() throws Exception {
        ...
        // Get the sTAttribute
        restSTAttributeMockMvc.perform(get("/api/s-t-attributes/{id}", sTAttribute.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void getNonExistingSTAttribute() throws Exception {
        // Get the sTAttribute
        restSTAttributeMockMvc.perform(get("/api/s-t-attributes/{id}", Long.MAX_VALUE))
    ...
    public void updateSTAttribute() throws Exception {
        ...
        restSTAttributeMockMvc.perform(put("/api/s-t-attributes")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
    ...
    public void deleteSTAttribute() throws Exception {
        ...
        // Get the sTAttribute
        restSTAttributeMockMvc.perform(delete("/api/s-t-attributes/{id}", sTAttribute.getId())

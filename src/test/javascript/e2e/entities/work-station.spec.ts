...
describe('WorkStation e2e test', () => {
    ...
    it('should load WorkStations', () => {
        ...
        expect(workStationComponentsPage.getTitle()).toMatch(/sfiApp.workStation.home.title/);
    ...
    it('should load create WorkStation dialog', () => {
        ...
        expect(workStationDialogPage.getModalTitle()).toMatch(/sfiApp.workStation.home.createOrEditLabel/);

...
describe('Supply e2e test', () => {
    ...
    it('should load Supplies', () => {
        ...
        expect(supplyComponentsPage.getTitle()).toMatch(/sfiApp.supply.home.title/);
    ...
    it('should load create Supply dialog', () => {
        ...
        expect(supplyDialogPage.getModalTitle()).toMatch(/sfiApp.supply.home.createOrEditLabel/);
